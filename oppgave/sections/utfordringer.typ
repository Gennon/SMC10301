...
Banker vil kunne miste kundeinnsikt ved at de ikke lenger har direkte kontakt med kundene. Dette kan føre til at bankene mister muligheten til å tilby skreddersydde produkter og tjenester som møter kundenes behov. De vil fortsatt ha tilgang til data om transaksjoner og økonomisk atferd som i dag, men fintech-selskaper vil kunne sitte på mer data og innsikt enn hva bankene har mulighet til å få tilgang til.
...
De tradisjonelle bankene har en sterk tillit og flere har også en god lokal tilhørighet. Dette kan være en fordel for bankene i konkurransen med fintech-selskaper som Klarna. Bankene vil også kunne tilby kundene produkter som fintech-selskaper mest sannsynlig ikke kan tilby grunnet reguleringer og tilsyn som krever for mye ressurser og kostnader #cite(<fintechØkonomi>). 
#quote(
  attribution: [#cite(<fintechØkonomi>)],
